...
class dlgBlueHudSettings {
	...
	class txtRole : ctrlBlueHudText {
		idc = -1;
		text = "Select role:";
		y = safeZoneY + safeZoneH/2 - 0.095 -0.109;
	};

	class cmbRole : ctrlBlueHudCmb {
		idc = 1;
	...
	class txtCompass : ctrlBlueHudText {
		idc = -1;
		text = "Show compass";
		y = safeZoneY + safeZoneH/2 - 0.027 -0.109;
	};

	class cbCompass : ctrlBlueHudCheckbox {
		idc = 3;
	...
	class txtSquad : ctrlBlueHudText {
		idc = -1;
		text = "Only show squad members";
		y = safeZoneY + safeZoneH/2 + 0.043 -0.109;
	};

	class cbSquad : ctrlBlueHudCheckbox	{
		idc = 4;
	...
	class txtFOV : ctrlBlueHudText {
		idc = -1;
		text = "HUD mode:";
		y = safeZoneY + safeZoneH/2 + 0.253 -0.109;
	};

	class cmbFOV : ctrlBlueHudCmb {
		idc = 7;
		x = safeZoneX + safeZoneW/2 - 0.1 - (0.025 * 3/4);
